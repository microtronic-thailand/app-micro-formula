...
import { createQuotation, getCustomers, getProducts } from "@/lib/data-service";
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        กรอกรายละเอียดเพื่อสร้างแผนเสนอราคาให้ลูกค้า
                    </p>
                </div>
                ...
                <form className="space-y-8">
                    ...
                    <div className="grid gap-4">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>หมายเหตุ (Notes)</FormLabel>
                                    <FormControl>
                                        <Input {...field} placeholder="เงื่อนไขการชำระเงิน, กำหนดยืนราคา..." />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
...
function QuotationItemRow({ index, form, remove, products }: { index: number, form: UseFormReturn<any>, remove: (index: number) => void, products: Product[] }) {
